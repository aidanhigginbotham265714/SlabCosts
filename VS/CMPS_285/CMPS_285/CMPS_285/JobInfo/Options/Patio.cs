...
namespace CMPS_285
{
    class Patio : Options
    {
        ...
        public Patio(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_patio; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 8; //TODO get database info
