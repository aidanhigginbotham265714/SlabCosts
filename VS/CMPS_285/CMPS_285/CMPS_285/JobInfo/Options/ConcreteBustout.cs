...
namespace CMPS_285
{
    class ConcreteBustout : Options
    {
        ...
        public ConcreteBustout(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_concreteBustout; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 3; //TODO get database info
