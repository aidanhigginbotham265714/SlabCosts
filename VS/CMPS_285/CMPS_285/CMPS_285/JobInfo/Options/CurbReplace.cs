...
namespace CMPS_285
{
    class CurbReplace : Options
    {
        ...
        public CurbReplace(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_curbReplace; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 24; //TODO get database info
