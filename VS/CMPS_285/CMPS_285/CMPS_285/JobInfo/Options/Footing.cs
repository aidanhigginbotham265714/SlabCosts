...
namespace CMPS_285
{
    class Footing : Options //default footing assumed to be 12x12 with #3 rods
    {
        ...
        public Footing(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_footing; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 13; //TODO get database info
