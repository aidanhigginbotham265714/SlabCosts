...
namespace CMPS_285
{
    class Curb : Options
    {
        ...
        public Curb(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_curb; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 25; //TODO get database info
