...
namespace CMPS_285
{
    class SidewalkReplace : Options
    {
        ...
        public SidewalkReplace(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_sidewalkReplace; //TODO, get name from the constants class.
