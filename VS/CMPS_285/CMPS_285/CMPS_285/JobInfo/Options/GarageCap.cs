...
namespace CMPS_285
{
    class GarageCap : Options
    {
        ...
        public GarageCap(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_garageCap; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 7; //TODO get database info
