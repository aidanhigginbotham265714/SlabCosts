...
namespace CMPS_285
{
    class Sawcut : Options
    {
        ...
        public Sawcut(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_sawcut; //TODO, get name from the constants class.
