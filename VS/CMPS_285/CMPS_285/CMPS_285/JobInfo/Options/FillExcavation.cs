...
namespace CMPS_285
{
    class FillExcavation : Options
    {
        ...
        public FillExcavation(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_fillExcavation; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 1; //TODO get database info
