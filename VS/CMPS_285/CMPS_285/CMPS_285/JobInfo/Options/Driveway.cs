...
namespace CMPS_285
{
     class Driveway : Options
    {
        ...
        public Driveway(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_driveway; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 5; //TODO get database info
