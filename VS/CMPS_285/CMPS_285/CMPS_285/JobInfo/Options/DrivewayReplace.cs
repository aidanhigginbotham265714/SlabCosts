...
namespace CMPS_285
{
    class DrivewayReplace : Options
    {
        ...
        public DrivewayReplace(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_drivewayReplace; //TODO, get name from the constants class.
            ...
            _unitPriceMedium = 9; //TODO get database info
