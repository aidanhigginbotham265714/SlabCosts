...
namespace CMPS_285
{
    class WoodDeckRemove : Options
    {
        ...
        public WoodDeckRemove(/*TODO double databasePrices*/) //Driveway varName = new Driveway();
        {
            _name = Constants.o_woodDeckRemove; //TODO, get name from the constants class.
